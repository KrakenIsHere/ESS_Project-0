...
public class MoveLightMoveables : BaseBehaviour
{
    ...
    public float repositionRate = 100f;
    ...
    public string liftTag = "Light Moveables";


    private string weightClass = "Light";
    ...
    void UpdateGameSettings()
    {
        ...
        currentlyGrabbed = GameSettings.CurrentlyGrabbed.LightMoveablesGrabbed;
        gameSettings.currentlyGrabbed = currentlyGrabbed;
    }
