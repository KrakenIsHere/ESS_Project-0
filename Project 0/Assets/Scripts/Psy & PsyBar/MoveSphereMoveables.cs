...
public class MoveSphereMoveables : BaseBehaviour
{
    ...
    public string liftTag = "Sphere Moveables";


    private string weightClass = "Sphere";
    ...
    void UpdateGameSettings()
    {
        ...
        currentlyGrabbed = GameSettings.CurrentlyGrabbed.SphereMoveablesGrabbed;
        gameSettings.currentlyGrabbed = currentlyGrabbed;
    }
