...
public class MoveNormalMoveables : BaseBehaviour
{
    private GameSettings.CurrentlyGrabbed currentlyGrabbed;
    ...
    public string liftTag = "Moveables";


    private string weightClass = "Normal";
    ...
    void UpdateGameSettings()
    {
        ...
        currentlyGrabbed = GameSettings.CurrentlyGrabbed.NormalMoveablesGrabbed;
        gameSettings.currentlyGrabbed = currentlyGrabbed;
    }
