...
public class MoveHeavyMoveables : BaseBehaviour
{
    ...
    public float chargeRate = 6.25f;

    [Comment("Maximum force of a throw/push", helpButton: true)]
    public float maxThrowForce = 2.5f;
    ...
    public float repositionRate = 6.25f;
    ...
    public string liftTag = "Heavy Moveables";


    private string weightClass = "Heavy";
    ...
    void UpdateGameSettings()
    {
        ...
        currentlyGrabbed = GameSettings.CurrentlyGrabbed.HeavyMoveablesGrabbed;
        gameSettings.currentlyGrabbed = currentlyGrabbed;
    }
