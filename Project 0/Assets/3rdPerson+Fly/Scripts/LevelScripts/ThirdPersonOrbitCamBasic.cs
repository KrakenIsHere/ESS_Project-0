...
public class ThirdPersonOrbitCamBasic : MonoBehaviour 
{
	...
	void Awake()
	{
        ...
        LockCursor = gameSettings.CursorLock;
        IsPaused = gameSettings.GameIsPaused;
	...
	void Update()
	{
        // Gets updates values from GameSettings To Update GameState.
        UpdateGameSettings();
